            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-sm text-[#86868B] mb-4 max-w-md">
                        ...
                        <div className="flex items-center gap-4">
                            <a
                                ...
                                className="p-2 text-[#86868B] hover:text-[#1D1D1F] hover:bg-black/5 rounded-lg transition-colors"
                                aria-label="GitHub"
                            >
                                <Github size={18} />
                            </a>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/about" className="text-sm text-[#86868B] hover:text-[#007AFF] transition-colors flex items-center gap-1 group">
                                    About
                                    <ExternalLink size={12} className="opacity-0 group-hover:opacity-50 transition-opacity" />
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" className="text-sm text-[#86868B] hover:text-[#007AFF] transition-colors flex items-center gap-1 group">
                                    Contact
                                    <ExternalLink size={12} className="opacity-0 group-hover:opacity-50 transition-opacity" />
                                </Link>
                            </li>
                            <li>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-sm text-[#86868B] hover:text-[#007AFF] transition-colors flex items-center gap-1 group"
                                >
                                    GitHub
                                    <ExternalLink size={12} className="opacity-0 group-hover:opacity-50 transition-opacity" />
                                </a>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/privacy" className="text-sm text-[#86868B] hover:text-[#007AFF] transition-colors">
                                    Privacy Policy
                                </Link>
                            </li>
                            <li>
                                <Link href="/terms" className="text-sm text-[#86868B] hover:text-[#007AFF] transition-colors">
                                    Terms of Service
                                </Link>
                            </li>
                            <li>
