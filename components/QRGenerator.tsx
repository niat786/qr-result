        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <select
                value={formData.locationType || 'address'}
        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <select
                value={formData.currency || 'bitcoin'}
        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={formData.upiId || formData.mobile || ''}
                onChange={(e) => handleFormChange('upiId', e.target.value)}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-6">
        ...
        <button
          ...
          className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none whitespace-nowrap"
        >
